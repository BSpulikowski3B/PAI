<html lang="pl">
    ...
    <form action="./Funkcje.php" method="POST">
        <a><b>Podaj swój wiek:</a> <input type="number" name="n" value="n" style="background-color: lightyellow; font">
        <input type="submit" value="wyslij"><br><br>
    </form>

    <form action="./Funkcje.php" method="POST">
            <a><b>wpisz tekst:</a> <input type="textarea" name="text" placeholder="wprowadz text" style="background-color: lightyellow; font">
